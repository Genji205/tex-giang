            ...
            <table class="dashboard-table">
              ...
              <tbody>
                <tr v-for="(row, rIdx) in data2024.rows" :key="'r24-'+rIdx">
                  ...
                  <td class="cell-avg-val">{{ calculateAverage(row.months, 2024) }}</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table class="dashboard-table">
              ...
              <tbody>
                <tr v-for="(row, rIdx) in data2025.rows" :key="'r25-'+rIdx">
                  ...
                  <td class="cell-avg-val">{{ calculateAverage(row.months, 2025) }}</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <table class="print-data-table">
            ...
            <tbody>
              <tr v-for="(row, rIdx) in data2024.rows" :key="'pr24-'+rIdx">
                ...
                <td class="cell-avg">{{ calculateAverage(row.months, 2024) }}</td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          <table class="print-data-table">
            ...
            <tbody>
              <tr v-for="(row, rIdx) in data2025.rows" :key="'pr25-'+rIdx">
                ...
                <td class="cell-avg">{{ calculateAverage(row.months, 2025) }}</td>
              </tr>
            </tbody>
          </table>
        </div>
...
export default {
  ...
  methods: {
    ...
    calculateAverage(months, year) {
      const avg = this.computeRawAvg(months);
