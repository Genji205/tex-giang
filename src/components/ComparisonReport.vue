            ...
            <table class="dashboard-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="cell-avg-val text-center">{{ calculateRowAvg(data2024.rows[0].months, selectedYear - 1) }}</td>
                </tr>
                <tr>
                  ...
                  <td class="cell-avg-val text-center">{{ calculateRowAvg(data2025.rows[0].months, selectedYear) }}</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table class="dashboard-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="cell-avg-val text-center">{{ calculateRowAvg(data2024.rows[1].months, selectedYear - 1) }}</td>
                </tr>
                <tr>
                  ...
                  <td class="cell-avg-val text-center">{{ calculateRowAvg(data2025.rows[1].months, selectedYear) }}</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div class="print-chart-block">
          ...
          <div class="paper-chart-flex">
            ...
            <div class="paper-svg-container">
              <svg viewBox="0 0 840 150" class="paper-svg-chart">
                <!-- Grid Lines -->
          ...
          <table class="print-data-table">
            <thead>
              <tr>
                <th style="width: 15.5%; text-align: left; padding-left: 6px; font-weight: normal; border: 1px solid #000; font-family: 'Times New Roman', Times, serif; font-size: 10px;"></th>
                <th v-for="m in 12" :key="'pax1-'+m" style="width: 6.5%; border: 1px solid #000; font-weight: normal; font-family: 'Times New Roman', Times, serif; font-size: 10px;">Tháng {{ m }}</th>
                <th style="width: 6.5%; border: 1px solid #000; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-size: 10px;">Trung Bình</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td class="cell-avg-val-center">{{ calculateRowAvg(data2024.rows[0].months, selectedYear - 1) }}</td>
              </tr>
              <tr>
                <td class="cell-label cell-legend-label" style="width: 15.5%;">
                ...
                <td class="cell-avg-val-center">{{ calculateRowAvg(data2025.rows[0].months, selectedYear) }}</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div class="print-chart-block margin-top-md">
          ...
          <table class="print-data-table">
            <thead>
              <tr>
                <th style="width: 15.5%; text-align: left; padding-left: 6px; font-weight: normal; border: 1px solid #000; font-family: 'Times New Roman', Times, serif; font-size: 10px;"></th>
                <th v-for="m in 12" :key="'pax2-'+m" style="width: 6.5%; border: 1px solid #000; font-weight: normal; font-family: 'Times New Roman', Times, serif; font-size: 10px;">Tháng {{ m }}</th>
                <th style="width: 6.5%; border: 1px solid #000; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-size: 10px;">Trung Bình</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td class="cell-avg-val-center">{{ calculateRowAvg(data2024.rows[1].months, selectedYear - 1) }}</td>
              </tr>
              <tr>
                <td class="cell-label cell-legend-label" style="width: 15.5%;">
                ...
                <td class="cell-avg-val-center">{{ calculateRowAvg(data2025.rows[1].months, selectedYear) }}</td>
              </tr>
            </tbody>
          </table>
        </div>
...
.paper-x-axis {
  display: flex;
  width: 100%;
  padding-left: 15.5%; /* Offset matching Y-axis width */
  margin-top: 4px;
}
